...
import { useGetUserDetailsByIdQuery } from "../../redux/api/users/usersAPI";
import { getUserInfo } from "../../services/authService";
import { useAddUserIntoContactMutation } from "../../redux/api/messenger/messengerAPI";
...
const UserProfile = () => {
  ...
  // Get Teacher Details
  const { data } = useGetUserDetailsByIdQuery(id);

  // Add User Into Contact
  const [addUserIntoContact] = useAddUserIntoContactMutation();
  ...
  const handleSendMessage = async () => {
    const mycontact = {
      ...
      reciverImg: data?.profileImage
        ? data?.profileImage
        : "https://blossom-academy-images.s3.amazonaws.com/dummy.png",
    };

    await addUserIntoContact(mycontact);
